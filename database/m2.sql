...
INSERT INTO `__efmigrationshistory` VALUES ('20240906085633_first','8.0.8'),('20240907085543_config','8.0.8'),('20240907122409_d1','8.0.8'),('20240907123603_d2','8.0.8'),('20240907194543_adding photo','8.0.8');
...
INSERT INTO `aspnetroles` VALUES ('5ebfbf55-0df6-4461-9de2-6d01a19fffd7','Admin','ADMIN','9b46c369-59f3-4f55-8f9d-9ada50f9956e'),('bc2d9049-9213-485f-a239-474db3adad2e','Customer','CUSTOMER','f983260b-9e23-4f36-8ac1-4359a996631b'),('d025c352-1d46-44e6-8c87-c52e7afa147d','Employee','EMPLOYEE','dd9dd0db-2f1a-4bd0-9c98-7083673977ae');
...
INSERT INTO `aspnetuserroles` VALUES ('3b702d32-9440-42c6-a65b-35129cf5ce64','bc2d9049-9213-485f-a239-474db3adad2e');
...
INSERT INTO `aspnetusers` VALUES ('3b702d32-9440-42c6-a65b-35129cf5ce64','jj','userqqq@example.com','RnpzRuYTDtG4ZLileR9tE3Ut6','RNPZRUYTDTG4ZLILER9TE3UT6','USERQQQ@EXAMPLE.COM',0,'AQAAAAIAAYagAAAAEFfQBYoebiw6hsUamnTsugGstZpYqj7KTJztOhyBvSn8nzA99nRSKHXCtFPXknf3TQ==','F2NDPWJDJF5WYIORT4GVDBHVJ62B45SC','890d6141-9ad9-4128-aa9d-42f49a8b48fd',NULL,0,0,NULL,1,0,'mahmoudnour');
...
CREATE TABLE `carts` (
  ...
  PRIMARY KEY (`id`),
  KEY `IX_Carts_CustomerId` (`CustomerId`),
...
CREATE TABLE `products` (
  ...
  KEY `IX_Products_Discountid` (`Discountid`),
...
-- Dump completed on 2024-09-07 23:57:27
